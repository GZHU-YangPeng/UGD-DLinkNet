...
class MassaChu(object):
    ...
    **Parameters:**
    ...
    def __init__(self, root, split_ration=0.8):
        ...
        self.val_imgs_dir = os.path.join(self.root, 'val')            # 默认'val'       改为 test，边训练边测试，显示测试集效果
        self.val_masks_dir = os.path.join(self.root, 'val_mask')     # 默认'val_mask'    test_mask
...
class CHN6(object):
    ...
    **Parameters:**
    ...
    def __init__(self, root, split_ration=0.8):
        ...
        self.masks_dir = os.path.join(self.root, 'mask')
        self.split_ration = split_ration
...
class CHN6_test(object):
    ...
    **Parameters:**
    ...
    random.seed(0)
    def __init__(self, root, split_ration=1):
        # self.root = os.path.expanduser(root)
        ...
        self.val_files = self.get_files()
        print(
            f"test image num: {len(self.val_files)}"
        )
