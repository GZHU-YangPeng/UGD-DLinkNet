...
from utils.data_manager import DeepGlobe,MassaChu,CHN6
...
parser.add_argument(
        '--datasetdir', type=str, default='../dataset/CHN6', help='The address of the dataset'
    )
parser.add_argument(
...
#The part of init
    now = datetime.now()
    args.out = osp.join('./logs_0614/CHN6', here.split('/')[-1], now.strftime(osp.join(args.model_name,'S_%Y%m%d_%H%M%S.%f_{}'.format(args.teach))))
...
#The part of dataset
    dataset = CHN6(root = args.datasetdir)
