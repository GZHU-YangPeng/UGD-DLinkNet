...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(feat_encoder_1)
        feat_encoder_2 = self.encoder2(F.max_pool2d(input = feat_encoder_1, kernel_size=2))
        feat_encoder_3 = self.encoder3(F.max_pool2d(input = feat_encoder_2, kernel_size=2))
        feat_encoder_4 = self.encoder4(F.max_pool2d(input = feat_encoder_3, kernel_size=2))
        feat_encoder_5 = self.encoder5(F.max_pool2d(input = feat_encoder_4, kernel_size=2))
